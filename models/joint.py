...
class Joint(ContinualModel):
    ...
    def end_task(self, dataset):
        ...
        test_loader = torch.utils.data.DataLoader(dataset.test_loaders[0].dataset, batch_size=self.args.batch_size)
        ...
        for e in range(self.args.n_epochs):
            for i, batch in enumerate(tqdm(loader, desc=f'Epoch {e + 1}/{self.args.n_epochs}', disable=self.args.non_verbose)):
