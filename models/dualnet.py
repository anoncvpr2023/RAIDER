...
def add_dualnet_args(parser: ArgumentParser):
    parser.add_argument('--n_outer', type=int, default=3, help='Number of teacher (slow) loops')
    parser.add_argument('--n_inner', type=int, default=2, help='Number of student (fast) loops')   
